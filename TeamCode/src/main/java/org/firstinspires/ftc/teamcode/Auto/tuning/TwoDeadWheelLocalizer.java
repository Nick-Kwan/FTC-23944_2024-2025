...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1.9936540882278315; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2.66089221575276; // x position of the perpendicular encoder (in tick units)
    }
