...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3.0480885773245894; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2.81778828334663; // x position of the perpendicular encoder (in tick units)
    }
