...
@Config
@Autonomous(name = "modSpecimen", group = "Autonomous")
public class modSpecimen extends LinearOpMode{
    PinpointDrive drive;
    ...
    public Action specimens(){
        return drive.actionBuilder(start)
                ...
                .setTangent(0)
                .splineToConstantHeading(new Vector2d(37, 3), 0,aVelConstraint,new ProfileAccelConstraint(-30,80))
                .afterTime(0, new ParallelAction(
                        bot.armSpecAction()
                ))
                .waitSeconds(0.175)
                ...
                .splineToConstantHeading(new Vector2d(40,10),-5*Math.PI/8,aVelConstraint, new ProfileAccelConstraint(-30,80))
                .afterTime(0, new ParallelAction(
                        bot.slideSpecAction(),
                        bot.armSpecAction()
                ))
                ...
                .splineToConstantHeading(new Vector2d(39,7),0,baseVelConstraint)
                .afterTime(0, new ParallelAction(
                        bot.slideSpecAction(),
                        bot.armSpecAction()
                ))
                ...
                .splineToConstantHeading(new Vector2d(28,15),-7*(Math.PI/8),aVelConstraint, new ProfileAccelConstraint(-30,80))
                .splineToConstantHeading(new Vector2d(42,15),0,baseVelConstraint,new ProfileAccelConstraint(-80,10)) // prev y:12
                .afterTime(0, new ParallelAction(
                        bot.slideSpecAction(),
                        bot.armSpecAction()
                ))
